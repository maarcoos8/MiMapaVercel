...
API REST para la aplicación MiMapa, que permite a los usuarios gestionar mapas personales con marcadores de lugares visitados.
...
### ✅ Mapas y Geocoding
- Marcadores en países/ciudades visitadas
- Geocoding automático usando Nominatim (OpenStreetMap)
- Coordenadas almacenadas en MongoDB
- Asociación de marcadores por email de usuario

### ✅ Gestión de Imágenes
- Subida de imágenes al crear marcadores
- Dos modos de almacenamiento:
  - **Cloudinary**: Almacenamiento en la nube (recomendado para producción)
  - **Base64 en DB**: Almacenamiento directo en MongoDB (para desarrollo)

### ✅ Visualización de Mapas
- Ver tu propio mapa con todos tus marcadores
- Visitar mapas de otros usuarios (solo lectura) ingresando su email
- API pública para consulta de mapas
