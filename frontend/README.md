...
Aplicación móvil/web para gestionar mapas personales con marcadores de lugares visitados.
...
### ✅ Mi Mapa
- Visualización de todos tus marcadores
- Galería de imágenes de lugares visitados
- Eliminar marcadores
- Vista de mapa interactivo con Leaflet

### ✅ Añadir Lugares
- Formulario para agregar países/ciudades
- Upload de imágenes
- Geocoding automático
- Descripción opcional

### ✅ Visitar Mapas
- Buscar mapas de otros usuarios por email
- Vista de solo lectura
- Visualización de marcadores e imágenes
